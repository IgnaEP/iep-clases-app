...
st.markdown("Bienvenido a la Liga. Aquí puedes ver tus estadísticas y registrar tus partidos (clases).")
...
if nombre_profe:
    ...
    with st.expander("➕ Registrar Nueva Clase"):
        with st.form("nueva_clase"):
            ...
            if submit:
                # Aquí crearíamos la lógica para guardar. Por ahora, simulación:
                st.success(f"¡Clase de {alumno} registrada! (Los datos se enviarán a tu Sheets)")
